...
class FacebookExceptionsTest extends TestCase
{
    ...
    public function testComments()
    {
        Assert::exception(
            ...
            'Link must be in correct format.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'These values (limit, width) must be integer.'
        );
    ...
    public function testLike()
    {
        ...
        Assert::exception(
            ...
            InputException::class,
            'These values (shareButton, showFaces) must be boolean.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'Layout must be select from options.'
        );
    ...
    public function testShare()
    {
        Assert::exception(
            ...
            InputException::class,
            'Share link must be in correct format.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'This value (mobileFrame) must be boolean.'
        );
    }
    ...
    public function testFollow()
    {
        Assert::exception(
            ...
            InputException::class,
            'Follow link must be defined in correct format.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'This value (showFaces) must be boolean.'
        );
    }
    ...
    public function testPage()
    {
        Assert::exception(
            ...
            InputException::class,
            'Facebook page URL must be defined in correct format.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'Tab must be select from options.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'Width must be in this range -> (180-500)px.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'Height must be bigger then 70px.'
        );
        ...
        Assert::exception(
            ...
            InputException::class,
            'These values (smallHeader,hideCoverPhoto,showFaces) must be boolean.'
        );
    }
